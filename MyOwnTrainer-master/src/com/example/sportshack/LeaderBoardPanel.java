...
public class LeaderBoardPanel extends SurfaceView implements SurfaceHolder.Callback {
    LeaderBoardActivity context;
    PanelThread _thread;      
    public Paint paint = new Paint();

    //Constructors
    public LeaderBoardPanel(Context context) { 
        super(context);
        this.context = (LeaderBoardActivity) context;          
